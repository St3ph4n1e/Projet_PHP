...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <form action="recherche.php" method="POST" name="recherche" class="d-flex">
        <input class="form-control me-2" type="recherche" name="valeur-recherche" placeholder="Que cherchez-vous ?" aria-label="Search">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link " href="connexion.php" tabindex="-1" aria-disabled="true">Nom utilisateur<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
